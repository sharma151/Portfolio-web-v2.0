    ...
    >
      <div className="text-[var(--text-color)]">
        <p className="text-base md:text-lg leading-relaxed md:leading-relaxed text-[var(--text-color)] md:text-justify">
          Hi, I'm{" "}
          <span className="text-purple-500 font-semibold">Saurav Sharma</span>{" "}
          from{" "}
          ...
          , and{" "}
          <span className="text-purple-500 font-semibold">Oasis Infobyte</span>{" "}
        ...
        <div className="mt-8">
          <h3 className="text-xl md:text-2xl font-semibold mb-4 text-purple-500 text-center">
            Things I ❤️ Besides Coding
          </h3>
          <ul className="list-disc ml-6 space-y-2 text-[var(--text-color)]">
            <li className="flex items-start">
              <ImPointRight className="text-purple-500 mr-2 mt-1 flex-shrink-0" />
              Playing Games 🎮
            </li>
            <li className="flex items-start">
              <ImPointRight className="text-purple-500 mr-2 mt-1 flex-shrink-0" />
        ...
        <p className="mt-8 md:mt-10 text-center italic text-purple-500 text-base md:text-lg">
