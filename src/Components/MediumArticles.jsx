...
const MediumArticles = () => {
  ...
  return (
    <section ref={ref} className="py-16 px-4 max-w-6xl mx-auto">
      ...
      >
        <h2 className="text-3xl font-bold text-center mb-12 text-purple-400">📝 Latest Articles</h2>
            ...
            {articles.map((article, index) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <div className="p-5">
                    <h3 className="text-lg font-semibold text-purple-400">{article.title}</h3>
